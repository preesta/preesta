...
namespace Tests.HtmlUriEscape
{
    ...
    {
        [Test, Description("Symbols such as '<', '>', quotes and similar should be escaped for email body that is in html format")]
        public void JqlLinksEscaping()
        {
            ...
            var escaped1 = HttpUtility.HtmlEncode(unescaped1);
            ...
            var escaped2 = HttpUtility.HtmlEncode(unescaped2);
